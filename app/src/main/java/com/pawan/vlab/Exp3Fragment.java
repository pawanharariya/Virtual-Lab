...
import com.pawan.vlab.databinding.FragmentExp3Binding;
...
public class Exp3Fragment extends Fragment implements HelperMethods.DrawViewListener {
    ...
    private FragmentExp3Binding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FragmentExp3Binding.inflate(inflater, container, false);
        initUI();
        ...
        output.setOnClickListener(view -> {
            if (checkConnection()) navController.navigate(R.id.exp_3_to_output);
        });
