...
import com.pawan.vlab.databinding.FragmentExp4Binding;
...
public class Exp4Fragment extends Fragment implements HelperMethods.DrawViewListener {
    private RadioButton terminal1, terminal2, terminal3, terminal4, terminal5, terminal6, terminal7, terminal8, terminal9, terminal10;
    private Button checkConnection, undoButton, output;
    private DrawView drawView;
    private FragmentExp4Binding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FragmentExp4Binding.inflate(inflater, container, false);
        initUI();
        ...
        terminal9.setOnClickListener(view -> HelperMethods.connect(startInfo, terminal9, 9, view, this));
        terminal10.setOnClickListener(view -> HelperMethods.connect(startInfo, terminal10, 10, view, this));

        undoButton.setOnClickListener(view -> drawView.undoAction());
        output.setOnClickListener(view -> {
            if (checkConnection()) navController.navigate(R.id.exp_4_to_output);
        });
    ...
    private void initUI() {
        ...
        terminal9 = binding.terminal9;
        terminal10 = binding.terminal10;
